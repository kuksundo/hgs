<<<<<<< .mine
unit UnitRMISServer4BWQueryMain;
...
uses
  ...
  Vcl.OleCtrls, SHDocVw, IdHTTP, AdvGrid, DateUtils,
  ...
  tmsAdvGridExcel, UnitBWQueryInterface, UnitBQQueryConfig, UnitHhiOfficeNewsInterface,
  mORMotHttpClient, ralarm, Sea_Ocean_News_Class, UnitDPMSInfoClass,
  UnitFrameIPCMonitorRMIS
...
begin
  FCS.CreateHttpServer(BWQRY_ROOT_NAME, 'BWQuery.json', BWQRY_PORT_NAME, TServiceBWQuery, [TypeInfo(IBWQuery)], sicClientDriven, True);
...
function TServiceBWQuery.GetBWQryClass(AQueryName: RawUTF8; out AServerBusy: Boolean): TRawUTF8DynArray;
var
  LKey: string;
  LQueryName: string;
  LBQC: TBWQryClass;
...
function TServiceBWQuery.GetEngDiv_kWh(AYear, AMonth, ADay: integer): RawUTF8;
begin
