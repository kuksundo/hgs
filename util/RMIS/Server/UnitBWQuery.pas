...
type
  ...
  public
    FExeFilePath: string;
    FIsFirstDataArrived: Boolean;//최초 쿼리 완료 후 True 됨
...
begin
  ...
  //박용 경영 계획
  _GetBizPlanPerProduct('ZKA_ZKSDSOM01_D_C_Q201_201601', 7, FBWQryDataClass.FOrderPlanPerProduct);//ZKA_ZKSDSOM01_D_C_Q201를 수정함
  //엔진발전 경영 계획
  ...
  _GetBizPlanPerProduct('ZKA_ZKSDSOM01_D_C_Q206_201601', 3, FBWQryDataClass.FOrderPlanPerProduct);//ZKA_ZKSDSOM01_D_C_Q206를 수정함
  //로봇 경영계획이므로 제외
...
begin
  g_ClearMessage;
  g_DisplayMessage2MainForm(FormatDateTime('mm월 dd일, hh:nn:ss => ', now) + '=================');
...
//  FQryRunning := False;
  ...
  g_SetFormCaption(LStr + ' => ' + IntToStr(FQryCount) + ' Query Updated: ' + FormatDateTime('mm월 dd일, hh:nn:ss', now));
