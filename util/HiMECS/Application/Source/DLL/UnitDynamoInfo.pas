...
uses
  ...
  ExtCtrls, ComCtrls, JvExComCtrls, JvListView, JvExControls, JvPageList, CommonUtil,
...
begin
  ...
  try
    ...
    begin
      ...
      NextGrid1.Cell[4, i].AsString := GetTokenWithComma(LStr);
...
begin
  ...
  begin
    ...
    begin
      EngineLoad := StrToIntDef(NextGrid1.Cell[1, i].AsString, 0);
      EngineOutput := StrToFloatDef(NextGrid1.Cell[2, i].AsString, 0.0);
      GenEfficiency := StrToFloatDef(NextGrid1.Cell[3, i].AsString, 0.0);
      GenOutput := StrToFloatDef(NextGrid1.Cell[4, i].AsString, 0.0);
    end;
  end;
