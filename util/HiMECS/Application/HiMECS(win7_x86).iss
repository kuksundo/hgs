...
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\bdertl160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\dbrtl160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\designide160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
...
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\IndySystem160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\IndyCore160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\rtl160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\vcl160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\vclactnband160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\vcldb160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\vclimg160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\vclx160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\xmlrtl160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\bin\vclsmp160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Raize\CS5\Deploy\Win32\CodeSiteExpressPkg160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
Source: C:\Program Files (x86)\Embarcadero\RAD Studio\9.0\Redist\Win32\DSnap160.bpl; DestDir: {app}\systembpl; Flags:promptifolder
...
Source: e:\pjh\project\util\VisualComm\Component\bpl\ExtLib_DXE2.bpl; DestDir: {app}\systembpl; Flags:promptifolder
