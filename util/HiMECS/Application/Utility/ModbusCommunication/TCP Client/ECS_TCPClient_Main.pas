...
uses
  ...
  IPCThrd_ECS_kumo, IPCThrdClient_ECS_kumo, TCPConfig, ExtCtrls, inifiles, Menus,
  DataSave2FileThread, DataSaveConst, ComCtrls, ECS_Kumo_TCPUtil, JvDialogs;
...
type
  ...
  private
    ...
    FECSData: TEventData_ECS_kumo;//RTU simulate에 사용되는 Buffer
...
procedure TClientFrmMain.IdTCPClient1AfterBind(Sender: TObject);
begin
