...
uses
  ...
  Dialogs, CPort, DeCAL, IPCThrd_Kral, IPCThrdClient_Kral, ModbusComConst, CommonUtil,
...
type
  ...
  private
    ...
    FIPCClient: TIPCClient_Kral;//공유 메모리 및 이벤트 객체
    FIPCClient2: TIPCClient_Kral;//공유 메모리 및 이벤트 객체
...
begin
  ...
  FIPCClient := TIPCClient_Kral.Create(0, FSharedMemName, True);
  FIPCClient2 := TIPCClient_Kral.Create(0, IPCCLIENTNAME2, True);
