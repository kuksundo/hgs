...
procedure TFrameIPCMonitorAll.CommonCommunication(
...
procedure TFrameIPCMonitorAll.CreateDynamoIPCMonitor(
...
procedure TFrameIPCMonitorAll.CreateECSAVATIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateECSkumoIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateECSWoodwardIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateEngineParamIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateFlowMeterIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateGasCalcIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateKRALIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateLBXIPCMonitor(AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateMEXA7000IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateMT210IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreatePLCS7IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.CreateWT1600IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TFrameIPCMonitorAll.DYNAMO_OnSignal(Sender: TIPCThread_DYNAMO;
  Data: TEventData_DYNAMO);
begin
  CommonCommunication(psDynamo);
end;

procedure TFrameIPCMonitorAll.ECS_OnSignal_AVAT(Sender: TIPCThread_ECS_AVAT;
...
procedure TFrameIPCMonitorAll.ECS_OnSignal_kumo(Sender: TIPCThread_ECS_kumo;
...
procedure TFrameIPCMonitorAll.ECS_OnSignal_Woodward(
...
procedure TFrameIPCMonitorAll.EngineParam_OnSignal(
  Sender: TIPCThread_EngineParam; Data: TEventData_EngineParam);
begin
...
procedure TFrameIPCMonitorAll.FlowMeter_OnSignal(Sender: TIPCThread_FlowMeter;
...
procedure TFrameIPCMonitorAll.GasCalc_OnSignal(Sender: TIPCThread_GasCalc;
...
procedure TFrameIPCMonitorAll.KRAL_OnSignal(Sender: TIPCThread_KRAL;
...
procedure TFrameIPCMonitorAll.LBX_OnSignal(Sender: TIPCThread_LBX; Data: TEventData_LBX);
begin
...
procedure TFrameIPCMonitorAll.MEXA7000_OnSignal(Sender: TIPCThread_MEXA7000;
...
procedure TFrameIPCMonitorAll.MT210_OnSignal(Sender: TIPCThread_MT210;
...
procedure TFrameIPCMonitorAll.OverRide_DYNAMO(AData: TEventData_DYNAMO);
var
  i, LRadix: integer;
  LDataOk: Boolean;
begin
...
procedure TFrameIPCMonitorAll.OverRide_ECS_AVAT(AData: TEventData_ECS_AVAT);
var
  it: DIterator;
  pHiMap: THiMap;
...
procedure TFrameIPCMonitorAll.OverRide_ECS_kumo(AData: TEventData_ECS_kumo);
var
  it: DIterator;
  pHiMap: THiMap;
  i, j, k, BlockNo: integer;
...
procedure TFrameIPCMonitorAll.OverRide_ECS_kumo2(AData: TEventData_ECS_kumo);
var
  i,k: integer;
  Le: double;
  LRadix: integer;
...
procedure TFrameIPCMonitorAll.OverRide_FlowMeter(AData: TEventData_FlowMeter);
var
  LDataOk: Boolean;
begin
  //상속 받은 자손에서 구현할 것
...
procedure TFrameIPCMonitorAll.OverRide_GasCalc(AData: TEventData_GasCalc);
var
  i, LRadix: integer;
  LDouble: double;
begin
...
procedure TFrameIPCMonitorAll.OverRide_KRAL(AData: TEventData_KRAL);
var
  i,k, LValue: integer;
  Le: double;
  LRadix: integer;
...
procedure TFrameIPCMonitorAll.OverRide_LBX(AData: TEventData_LBX);
var
  i, LRadix: integer;
  LDouble: double;
  LDataOk: Boolean;
...
procedure TFrameIPCMonitorAll.OverRide_MEXA7000(AData: TEventData_MEXA7000_2);
var
  i, LRadix: integer;
  LDataOk: Boolean;
begin
...
procedure TFrameIPCMonitorAll.OverRide_MT210;
var
  i, LRadix: integer;
  LDataOk: Boolean;
begin
...
procedure TFrameIPCMonitorAll.OverRide_PLC_S7(AData: TEventData_PLC_S7);
var
...
procedure TFrameIPCMonitorAll.OverRide_WT1600(AData: TEventData_WT1600);
var
...
procedure TFrameIPCMonitorAll.PLC_S7_OnSignal(Sender: TIPCThread_PLC_S7;
...
procedure TFrameIPCMonitorAll.SetValue2ScreenEvent(
  AEventFunc: TWatchValue2Screen_AnalogEvent);
begin
  FWatchValue2Screen_AnalogEvent := AEventFunc;
end;

procedure TFrameIPCMonitorAll.UpdateTrace_DYNAMO(var Msg: TEventData_DYNAMO);
begin
...
procedure TFrameIPCMonitorAll.UpdateTrace_ECS_AVAT(var Msg: TEventData_ECS_AVAT);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_ECS_kumo(var Msg: TEventData_ECS_kumo);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_FlowMeter(var Msg: TEventData_FlowMeter);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_GasCalc(var Msg: TEventData_GasCalc);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_KRAL(var Msg: TEventData_KRAL);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_LBX(var Msg: TEventData_LBX);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_MEXA7000(var Msg: TEventData_MEXA7000);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_MT210(var Msg: TEventData_MT210);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_PLC_S7(var Msg: TEventData_PLC_S7);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.UpdateTrace_WT1600(var Msg: TEventData_WT1600);
begin
  if FIsSetZeroWhenDisconnect then
...
procedure TFrameIPCMonitorAll.Value2Screen_KRAL(AEPIndex: integer;
  AModbusMode: integer);
var
  Le: Single;
  LStr: string;
...
procedure TFrameIPCMonitorAll.WT1600_OnSignal(Sender: TIPCThread_WT1600;
