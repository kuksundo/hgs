unit UnitSTOMP2IPCMonitorAllConfig;
...
uses
  ...
  AdvGroupBox, Vcl.ComCtrls, Vcl.Buttons, Vcl.ExtCtrls, IniPersist, UnitConfigIniClass,
...
type
  ...
  TConfigF = class(TForm)
    ...
    Label6: TLabel;
    MQServerEnableEdit: TEdit;
    procedure MQServerEnableClick(Sender: TObject);
  private
...
procedure TConfigF.MQServerEnableClick(Sender: TObject);
begin
  MQServerEnableEdit.Text := BoolToStr(MQServerEnable.CheckBox.Checked);
end;
