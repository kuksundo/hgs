...
uses
  ...
  JvComponentBase, JvMouseGesture;
...
type
  TFrmEngineMonitoring = class(TForm)
    ...
    AI_EXH_B_9: TPanel;
    AI_EXH_B_Avg: TPanel;
    AI_EXH_B_TCINLET_A: TPanel;
    AI_EXH_B_TCOUTLET: TPanel;
    Panel10: TPanel;
    DI_TURNGEARDISENGAGED: TShadowButton;
...
procedure TFrmEngineMonitoring.DesignMode1Click(Sender: TObject);
begin
  DesignMode1.Checked := not DesignMode1.Checked;

  //SelectOnRunTime1.Active := DesignMode1.Checked;
end;
