unit ECS_DataSave_Main_Drillship;
...
uses
  ...
  IPCThrd_ECS_kumo, DataSave2FileThread_drillship, DataSave2DBThread, SyncObjs,inifiles,
...
begin
  ...
  begin
    ...
    if CB_CSVlogging.Checked then
    begin
      FSaveDataBuf :=#13#10+TimeToStr(Time) + FCSVHeader;
