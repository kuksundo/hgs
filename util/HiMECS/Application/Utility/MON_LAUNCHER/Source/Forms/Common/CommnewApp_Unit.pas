...
procedure TnewCommApp_Frm.AdvGlowButton1Click(Sender: TObject);
begin
  Close;
end;

procedure TnewCommApp_Frm.AdvGlowButton2Click(Sender: TObject);
begin
...
procedure TnewCommApp_Frm.Button1Click(Sender: TObject);
begin
...
procedure TnewCommApp_Frm.Button2Click(Sender: TObject);
begin
...
procedure TnewCommApp_Frm.Button3Click(Sender: TObject);
begin
  if OpenPictureDialog1.Execute then
  begin
