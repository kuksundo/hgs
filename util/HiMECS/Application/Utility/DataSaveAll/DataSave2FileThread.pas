...
uses
  Windows, Classes, Forms, MyKernelObject, CommonUtil, DataSaveAll_Const, SysUtils;
    ...
    begin
      ...
      begin
        ...
        case FName_Convention of
          ...
          FC_FIXED:
          begin
            SaveData2FixedFile('CSVFile',FFileName, FStrData, soFromEnd, FTagData);
          end;
        end;//case
