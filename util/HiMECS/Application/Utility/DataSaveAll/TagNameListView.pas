...
type
  ...
  public
    ...
    procedure GetTagList(ATagNameList, ADescriptList, AValueList: TStrings);
...
procedure TTagInfoEditorDlg.GetTagList(ATagNameList, ADescriptList, AValueList: TStrings);
var
  i: integer;
  LItem: TListItem;
begin
