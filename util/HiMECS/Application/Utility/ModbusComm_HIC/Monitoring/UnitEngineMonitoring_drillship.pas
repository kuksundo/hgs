unit UnitEngineMonitoring_drillship;
...
type
  TFrmEngineMonitoring = class(TForm)
    ...
    AI_FOPRESS: TiAnalogDisplay;
    StaticText10: TStaticText;
    AI_GOVACTPOS: TiAnalogDisplay;
    StaticText14: TStaticText;
    AI_HTTEMPOUTLET: TiAnalogDisplay;
    StaticText16: TStaticText;
    AI_TC_A_LOPRESS: TiAnalogDisplay;
    ...
    AI_LODRAINTC_A_TEMP: TiAnalogDisplay;
    StaticText27: TStaticText;
    AI_HTPRESSINLET: TiAnalogDisplay;
    StaticText30: TStaticText;
    AI_LODRAINTC_B_TEMP: TiAnalogDisplay;
    ...
    AI_CONTROLAIRPRESS: TiAnalogDisplay;
    Panel17: TPanel;
...
begin
  ...
  try
    ...
    begin
      ...
      if AMaxVal > 0 then
      begin
        if (AName = 'AI_TC_A_RPM') or (AName = 'AI_TC_B_RPM') then
          Le := Le * AMaxVal
        else
          Le := Le / AMaxVal;
      end;
      ...
      begin
        ...
        else if System.Pos('TE68',AName) > 0 then
        begin
          LComponent2 := FindComponent(AName+'_L');
          if Assigned(LComponent2) then
            TiLedBar(LComponent2).Position := Round(Le);
