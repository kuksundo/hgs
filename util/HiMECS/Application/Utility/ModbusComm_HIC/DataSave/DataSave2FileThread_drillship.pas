unit DataSave2FileThread_drillship;
...
uses ECS_DataSave_Main_Drillship;
      ...
      begin
        ...
        case FName_Convention of
          ...
          begin
            ...
            if SaveData2DateFile('CSVFile','csv', FStrData, soFromEnd) then
              SaveData2DateFile('CSVFile','csv', FTagData, soFromBeginning);
          end;
          FC_FIXED:
          begin
