...
var
  WT1600CommMDIF: TWT1600CommMDIF;
...
procedure TWT1600CommMDIF.InitVar;
begin
  FErrCnt := 0;
...
procedure TWT1600CommMDIF.FormCreate(Sender: TObject);
begin
  FFirst := True;
end;

procedure TWT1600CommMDIF.WMPowerMeterOn(var Msg: TMessage);
begin
...
procedure TWT1600CommMDIF.FormClose(Sender: TObject; var Action: TCloseAction);
var
  LMsg: TMessage;
begin
  LMsg.WParamLo := 0;
...
procedure TWT1600CommMDIF.DisplayMessage(msg: string; ADspNo: TDisplayTarget);
begin
  case ADspNo of
    dtSendMemo : begin
      if msg = ' ' then
...
procedure TWT1600CommMDIF.LoadConfigDataini2Form(ConfigForm: TWT1600ConfigF);
var
  iniFile: TIniFile;
begin
...
procedure TWT1600CommMDIF.LoadConfigDataini2Var;
var
  iniFile: TIniFile;
begin
  SetCurrentDir(FilePath);
...
procedure TWT1600CommMDIF.MakeCommand;
begin
...
procedure TWT1600CommMDIF.SaveConfigDataForm2ini(ConfigForm: TWT1600ConfigF);
var
  iniFile: TIniFile;
begin
  SetCurrentDir(FilePath);
...
procedure TWT1600CommMDIF.SetConfigData;
var
...
procedure TWT1600CommMDIF.SetCurrentCommandIndex(aIndex: integer);
begin
  if FCurrentCommandIndex <> aIndex then
    FCurrentCommandIndex := aIndex;
end;

procedure TWT1600CommMDIF.Timer1Timer(Sender: TObject);
begin
  with Timer1 do
  begin
    Enabled := False;
...
procedure TWT1600CommMDIF.CONSUMPTIONQDblClick(Sender: TObject);
begin
...
procedure TWT1600CommMDIF.WMCopyData(var Msg: TMessage);
begin
//  FCriticalSection.Enter;
  if FStop then
    exit;
...
procedure TWT1600CommMDIF.Value2Screen(AData: string);
var
...
procedure TWT1600CommMDIF.NullValue2Screen;
var
  EventData: TEventData2;
begin
...
procedure TWT1600CommMDIF.iSwitchLed1Click(Sender: TObject);
begin
  FWT1600CommThread.StopComm := not FWT1600CommThread.StopComm;
end;

procedure TWT1600CommMDIF.DestroyAll;
begin
  FCriticalSection.Enter;
