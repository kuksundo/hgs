...
type
  ...
  public
    ...
    procedure Value2Screen_ECS_kumo(AHiMap: THiMap; AEPIndex: integer);
    procedure Value2Screen_ECS_AVAT(AHiMap: THiMap; AEPIndex: integer);
...
procedure TWatchF1.LBX_OnSignal(Sender: TIPCThread_LBX; Data: TEventData_LBX);
begin

end;

procedure TWatchF1.LoadConfigDataVar2Form(AMonitorConfigF: TWatchConfigF);
begin
...
procedure TWatchF1.LoadConfigDataXml2Var;
var
  Lstr: string;
begin
...
procedure TWatchF1.SaveConfigData2Xml;
var
  Lstr: string;
begin
  Lstr := ChangeFileExt(Application.ExeName, CONFIG_FILE_EXT);
...
procedure TWatchF1.SaveConfigDataForm2Xml(AMonitorConfigF: TWatchConfigF);
var
  Lstr: string;
begin
  Lstr := ChangeFileExt(Application.ExeName, CONFIG_FILE_EXT);
...
procedure TWatchF1.SendFormCopyData(ToHandle: integer; AForm: TForm);
var
  cd : TCopyDataStruct;
begin
  with cd do
...
procedure TWatchF1.SetAlarm4OriginalOption(AValue: double; AEPIndex: integer);
var
  LSoundF: string;
begin
  if AValue > FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxAlarmValue then
  begin
    FCurrentChangeColor := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxAlarmColor;
    FBlinkEnable := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxAlarmBlink;
    ...
    if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxAlarmSoundEnable then
    begin
      if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxAlarmSoundFilename = '' then
        LSoundF := FConfigOption.DefaultSoundFileName
      else
        LSoundF := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxAlarmSoundFilename;

      ExecuteSound(LSoundF);
    end;
  end
  else
  if AValue > FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxWarnValue then
  begin
    FCurrentChangeColor := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxWarnColor;
    FBlinkEnable := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxWarnBlink;
    ...
    if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxWarnSoundEnable then
    begin
      if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxWarnSoundFilename = '' then
        LSoundF := FConfigOption.DefaultSoundFileName
      else
        LSoundF := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MaxWarnSoundFilename;

      ExecuteSound(LSoundF);
    end;
  end
  else
  if AValue < FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinAlarmValue then
  begin
    FCurrentChangeColor := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinAlarmColor;
    FBlinkEnable := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinAlarmBlink;
    ...
    if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinAlarmSoundEnable then
    begin
      if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinAlarmSoundFilename = '' then
        LSoundF := FConfigOption.DefaultSoundFileName
      else
        LSoundF := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinAlarmSoundFilename;

      ExecuteSound(LSoundF);
    end;
  end
  else
  if AValue < FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinWarnValue then
  begin
    FCurrentChangeColor := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinWarnColor;
    FBlinkEnable := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinWarnBlink;
    ...
    if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinWarnSoundEnable then
    begin
      if FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinWarnSoundFilename = '' then
        LSoundF := FConfigOption.DefaultSoundFileName
      else
        LSoundF := FEngineParameter.EngineParameterCollect.Items[AEPIndex].MinWarnSoundFilename;
...
procedure TWatchF1.SetAlarm4ThisOption(AValue: double);
begin
...
procedure TWatchF1.SetConfigData;
...
procedure TWatchF1.Timer1Timer(Sender: TObject);
begin
...
procedure TWatchF1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FMonitorStart := False;
  Action := caFree;
...
procedure TWatchF1.UpdateTrace_DYNAMO(var Msg: TEventData_DYNAMO);
begin
;
end;

procedure TWatchF1.UpdateTrace_ECS_AVAT(var Msg: TEventData_ECS_AVAT);
var
  it: DIterator;
  pHiMap: THiMap;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            //수신된 데이타를 화면에 뿌려줌
            Value2Screen_ECS_AVAT(pHiMap,k);
            break;
          end;
        end;
      end;//for
...
procedure TWatchF1.UpdateTrace_ECS_kumo(var Msg: TEventData_ECS_kumo);
var
  it: DIterator;
  pHiMap: THiMap;
  i, j, k, BlockNo: integer;
      ...
      begin
        ...
        begin
          ...
          begin
            pHiMap.FValue := FECSData_AVAT.InpDataBuf[i];
            //수신된 데이타를 화면에 뿌려줌
            Value2Screen_ECS_kumo(pHiMap,k);
            break;
          end;
        end;
      end;//for
...
procedure TWatchF1.UpdateTrace_LBX(var Msg: TEventData_LBX);
begin

end;

procedure TWatchF1.UpdateTrace_MEXA7000(var Msg: TEventData_MEXA7000);
begin
...
procedure TWatchF1.UpdateTrace_MT210(var Msg: TEventData_MT210);
begin
  //EngDataF.MT210Analog.Value := FMT210Data.FData;
  WatchValue2Screen_Analog(FLabelName, FWatchValue);
end;

procedure TWatchF1.UpdateTrace_WT1600(var Msg: TEventData_WT1600);
begin
  WatchValue2Screen_Analog(FLabelName, FWatchValue);
end;

procedure TWatchF1.Value2Screen_Analog_ECS_kumo(AName: string; AValue: Integer;
  AMaxVal: real);
var
  LisPress: boolean;
...
procedure TWatchF1.Value2Screen_Digital_ECS(Name: string; AValue: Integer;
  AMaxVal: real; AContact: integer);
begin

end;

procedure TWatchF1.Value2Screen_ECS_AVAT(AHiMap: THiMap; AEPIndex: integer);
var
  Le: Single;
  LIsFloat: boolean;
  LStr: string;
...
procedure TWatchF1.Value2Screen_ECS_kumo(AHiMap: THiMap; AEPIndex: integer);
var
  Le: Single;
begin
  if AHiMap.FAlarm then //Analog data
...
procedure TWatchF1.DestroyIPCMonitor(AExceptIPCMonitor: TParameterSource);
begin
...
procedure TWatchF1.Displayalldatainthischart1Click(Sender: TObject);
var
  Li : integer;
begin
...
procedure TWatchF1.DisplayMessage(Msg: string);
var
  i: integer;
begin
...
procedure TWatchF1.DisplayMessage2SB(Msg: string);
begin
  StatusBarPro1.SimplePanel := True;
  StatusBarPro1.SimpleText := Msg;
end;

procedure TWatchF1.DropTextTarget1Drop(Sender: TObject; ShiftState: TShiftState;
  APoint: TPoint; var Effect: Integer);
begin
...
procedure TWatchF1.DYNAMO_OnSignal(Sender: TIPCThread_DYNAMO;
  Data: TEventData_DYNAMO);
begin
;
end;

procedure TWatchF1.ECS_OnSignal_AVAT(Sender: TIPCThread_ECS_AVAT;
...
procedure TWatchF1.ECS_OnSignal_kumo(Sender: TIPCThread_ECS_kumo; Data: TEventData_ECS_kumo);
var
  i,dcount: integer;
begin
  if not FMonitorStart then
...
procedure TWatchF1.WatchValue2Screen_Analog(Name: string; AValue: string;
                                AEPIndex: integer; AIsFloat: Boolean = false);
var
  tmpdouble: double;
  //tmpValue: string;
...
begin
  ...
  try
    ...
    tmpdouble := StrToFloatDef(FEngineParameter.EngineParameterCollect.Items[FCurrentEPIndex4Watch].Value, 0.0);
    ...
    case PageControl1.ActivePageIndex of
      0: begin //simple
        ...
        begin
          WatchLabel.Caption := FEngineParameter.EngineParameterCollect.Items[FCurrentEPIndex4Watch].Value;
      ...
      1: begin //Min/Max
        ...
        CurLabel.Caption := FEngineParameter.EngineParameterCollect.Items[FCurrentEPIndex4Watch].Value;
      end;
      2: begin //Trend
...
procedure TWatchF1.WMCopyData(var Msg: TMessage);
begin
...
procedure TWatchF1.WT1600_OnSignal(Sender: TIPCThread_WT1600;
...
procedure TWatchF1.FormDestroy(Sender: TObject);
begin
  FWatchValueAry := nil;
...
procedure TWatchF1.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TWatchF1.FormCreate(Sender: TObject);
begin
  InitVar;
end;

procedure TWatchF1.ChangeDispPanelColor(AColor: TColor);
var
  LColor: TColor;
begin
...
function TWatchF1.CheckExistTagName(AParameterSource: TParameterSource;
  ATagName: string): integer;
var
  i: integer;
begin
...
procedure TWatchF1.Close1Click(Sender: TObject);
begin
  Close;
end;

procedure TWatchF1.Config1Click(Sender: TObject);
begin
  SetConfigData;
end;

procedure TWatchF1.CreateDynamoIPCMonitor(
...
procedure TWatchF1.CreateECSAVATIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CreateECSkumoIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CreateFlowMeterIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CreateIPCMonitor(AEP_DragDrop: TEngineParameterItemRecord);
begin
...
procedure TWatchF1.CreateLBXIPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CreateMEXA7000IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CreateMT210IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CreateWT1600IPCMonitor(
  AEP_DragDrop: TEngineParameterItemRecord);
var
  LSM: string;
begin
...
procedure TWatchF1.CurrentValue1Click(Sender: TObject);
begin
...
procedure TWatchF1.Average1Click(Sender: TObject);
begin
...
procedure TWatchF1.MinValue1Click(Sender: TObject);
begin
...
procedure TWatchF1.MoveEngineParameterItemRecord(
  AEPItemRecord: TEngineParameterItemRecord);
var
  i: integer;
begin
  if CheckExistTagName(AEPItemRecord.FParameterSource,AEPItemRecord.FTagName) > -1 then
    exit;
  ...
  begin
    ...
    MinWarnEnable := AEPItemRecord.FMinWarnEnable;
    MaxWarnEnable := AEPItemRecord.FMaxWarnEnable;
    MinAlarmEnable := AEPItemRecord.FMinAlarmEnable;
    MaxAlarmEnable := AEPItemRecord.FMaxAlarmEnable;

    MinWarnValue := AEPItemRecord.FMinWarnValue;
    MaxWarnValue := AEPItemRecord.FMaxWarnValue;
    MinAlarmValue := AEPItemRecord.FMinAlarmValue;
    MaxAlarmValue := AEPItemRecord.FMaxAlarmValue;

    MinWarnColor := AEPItemRecord.FMinWarnColor;
    MaxWarnColor := AEPItemRecord.FMaxWarnColor;
    MinAlarmColor := AEPItemRecord.FMinAlarmColor;
    MaxAlarmColor := AEPItemRecord.FMaxAlarmColor;

    MinWarnBlink := AEPItemRecord.FMinWarnBlink;
    MaxWarnBlink := AEPItemRecord.FMaxWarnBlink;
    MinAlarmBlink := AEPItemRecord.FMinAlarmBlink;
    MaxAlarmBlink := AEPItemRecord.FMaxAlarmBlink;

    MinWarnSoundEnable := AEPItemRecord.FMinWarnSoundEnable;
    MaxWarnSoundEnable := AEPItemRecord.FMaxWarnSoundEnable;
    MinAlarmSoundEnable := AEPItemRecord.FMinAlarmSoundEnable;
    MaxAlarmSoundEnable := AEPItemRecord.FMaxAlarmSoundEnable;

    MinWarnSoundFilename := AEPItemRecord.FMinWarnSoundFilename;
    MaxWarnSoundFilename := AEPItemRecord.FMaxWarnSoundFilename;
    MinAlarmSoundFilename := AEPItemRecord.FMinAlarmSoundFilename;
    MaxAlarmSoundFilename := AEPItemRecord.FMaxAlarmSoundFilename;

    IsDisplayPlot := AEPItemRecord.FIsDisplayPlot;
    PlotChannelIndex := AEPItemRecord.FPlotChannelIndex;
...
procedure TWatchF1.MT210_OnSignal(Sender: TIPCThread_MT210;
...
procedure TWatchF1.OnChangeDispPanelColor(Sender: TObject; Handle: Integer;
  Interval: Cardinal; ElapsedTime: Integer);
begin
  ChangeDispPanelColor(TColor(FCurrentChangeColor));
end;

procedure TWatchF1.ReadMapAddress(AddressMap: DMap; MapFileName: string);
var
...
procedure TWatchF1.MaxValue1Click(Sender: TObject);
begin
...
procedure TWatchF1.MEXA7000_OnSignal(Sender: TIPCThread_MEXA7000;
...
procedure TWatchF1.AlphaTrackBarMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  AlphaBlendValue := AlphaTrackBar.Position;
end;

procedure TWatchF1.ApplyAvgSize;
begin
  FCriticalSection.Enter;
  try
    SetLength(FWatchValueAry, FConfigOption.AverageSize);
...
procedure TWatchF1.ApplyOption;
begin
...
procedure TWatchF1.FormShow(Sender: TObject);
begin
...
procedure TWatchF1.Button1Click(Sender: TObject);
begin
  FWatchValueMax := 0;
  FWatchValueMin := 0;
end;
