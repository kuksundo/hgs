...
uses Windows, Classes, SysUtils, IPCThrd_LBX;//, IPCThrdConst;

Type
{ TIPCMonitor_LBX }

  TIPCMonitor_LBX = class(TIPCThread_LBX)
  protected
...
constructor TIPCMonitor_LBX.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_LBX.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_LBX.DoOnSignal;
begin
