...
uses Windows, Classes, SysUtils, IPCThrd_DYNAMO;//, IPCThrdConst;

Type
{ TIPCMonitor_DYNAMO }

  TIPCMonitor_DYNAMO = class(TIPCThread_DYNAMO)
  protected
...
constructor TIPCMonitor_DYNAMO.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_DYNAMO.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_DYNAMO.DoOnSignal;
begin
