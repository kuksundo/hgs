object WT1600CommSDIF: TWT1600CommSDIF
  ...
  object PopupMenu1: TPopupMenu
    ...
    object GetEventName1: TMenuItem
      Caption = 'Get Event Name'
      OnClick = GetEventName1Click
    end
    object GetEngineName1: TMenuItem
      Caption = 'Get Engine Name'
      OnClick = GetEngineName1Click
    end
  end
