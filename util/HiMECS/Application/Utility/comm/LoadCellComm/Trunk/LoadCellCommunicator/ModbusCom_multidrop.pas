...
uses
  ...
  ALed, Switch, janSQL, janSQLStrings, CopyData, AppEvnts, SCLED;
...
begin  //#$D#$A가 없으면 쓰레드에서 이 함수로 넘어오지 않음
  ...
  begin
    ...
    StatusBar1.SimpleText := '마지막 데이터처리 : ' + DateTimeToStr(Now);
end;
...
procedure TModbusComF.Timer2Timer(Sender: TObject);
begin
