...
uses Windows, Classes, SysUtils, IPCThrd_PLC_S7;//, IPCThrdConst;

Type
{ TIPCMonitor_PLC_S7 }

  TIPCMonitor_PLC_S7 = class(TIPCThread_PLC_S7)
  protected
...
constructor TIPCMonitor_PLC_S7.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_PLC_S7.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_PLC_S7.DoOnSignal;
begin
