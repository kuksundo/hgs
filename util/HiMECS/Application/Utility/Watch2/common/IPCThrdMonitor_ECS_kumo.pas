...
uses Windows, Classes, SysUtils, IPCThrd_ECS_kumo;//, IPCThrdConst;

Type
{ TIPCMonitor_ECS }

  TIPCMonitor_ECS_kumo = class(TIPCThread_ECS_kumo)
  protected
...
{ TIPCMonitor_ECS_kumo }

constructor TIPCMonitor_ECS_kumo.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_ECS_kumo.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_ECS_kumo.DoOnSignal;
begin
