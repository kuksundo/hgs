...
uses
  SysUtils, Classes, Windows, MyKernelObject, IPCThrdConst_PMS;
...
{ Win32 events are very basic.  They are either signaled or non-signaled.
  ...
  TEventData_PMS = packed record
    InpDataBuf: array[0..600] of string[50];
  end;

  TIPCNotifyEvent_PMS = procedure (Sender: TIPCThread_PMS; Data: TEventData_PMS) of Object;

  PIPCEventInfo_PMS = ^TIPCEventInfo_PMS;
  TIPCEventInfo_PMS = record
    FID: Integer;
    FKind: TEventKind_PMS;
    FData: TEventData_PMS;
  end;
