...
uses Windows, Classes, SysUtils, IPCThrd_GasCalc;

Type
{ TIPCMonitor_GasCalc }

  TIPCMonitor_GasCalc = class(TIPCThread_GasCalc)
  protected
...
constructor TIPCMonitor_GasCalc.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_GasCalc.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_GasCalc.DoOnSignal;
begin
