unit IPCThrdMonitor_ECS_Woodward;
...
uses Windows, Classes, SysUtils, IPCThrd_ECS_Woodward;//, IPCThrdConst;

Type
{ TIPCMonitor_ECS }

  TIPCMonitor_ECS_Woodward = class(TIPCThread_ECS_Woodward)
  protected
...
{ TIPCMonitor_ECS_Woodward }

constructor TIPCMonitor_ECS_Woodward.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_ECS_Woodward.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_ECS_Woodward.DoOnSignal;
begin
