...
uses Windows, Classes, SysUtils, IPCThrd_MEXA7000;//, IPCThrdConst;

Type
{ TIPCMonitor_MEXA7000 }

  TIPCMonitor_MEXA7000 = class(TIPCThread_MEXA7000)
  protected
...
constructor TIPCMonitor_MEXA7000.Create(AID: Integer; const AName: string; AManual: Boolean);
begin
  inherited Create(AID, AName, AManual);
end;

procedure TIPCMonitor_MEXA7000.Execute;
var
  WaitResult: Integer;
begin
...
procedure TIPCMonitor_MEXA7000.DoOnSignal;
begin
