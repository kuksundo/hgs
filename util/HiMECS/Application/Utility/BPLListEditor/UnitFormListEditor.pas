...
uses
  ...
  JvCheckListBox, DragDropText, HiMECSFormCollect, Dialogs, NxColumnClasses,
...
begin
  ...
  FHiMECSConfig := THiMECSForms.Create(Self);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      NextGrid1.Cell[2,j].AsString := 'Create_' +  Copy(NextGrid1.Cell[1,j].AsString,1,pos('.',NextGrid1.Cell[1,j].AsString)-1);
...
begin
  ...
  begin
    ...
    begin
      ...
      FHiMECSConfig.SaveToFile(SaveDialog1.FileName,LStr,True);
      FItemChanged := False;
    end
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      FHiMECSConfig.LoadFromFile(OpenDialog1.FileName,LStr,True);
      NextGrid1.ClearRows;
