...
procedure TWatchF2.LoadConfigDataini2Form(ConfigForm: TWatchConfigF);
var
  iniFile: TIniFile;
begin
...
procedure TWatchF2.LoadConfigDataini2Var;
var
  iniFile: TIniFile;
begin
  SetCurrentDir(FFilePath);
...
procedure TWatchF2.SaveConfigDataForm2ini(ConfigForm: TWatchConfigF);
var
  iniFile: TIniFile;
begin
  SetCurrentDir(FFilePath);
...
procedure TWatchF2.OnSignal(Sender: TIPCThread2; Data: TEventData2);
var
  i,dcount: integer;
begin
...
procedure TWatchF2.UpdateTraceData(var Msg: TEventData2);
var
  i, j: integer;
  tmpStr: string;
