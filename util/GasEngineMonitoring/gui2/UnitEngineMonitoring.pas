unit UnitEngineMonitoring;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, ExtCtrls,
  Dialogs, DeCAL, janSQL, IPCThrd_ECS_avat, ModbusComStruct, IPCThrdMonitor_ECS_avat,
...
type
  TFrmEngineMonitoring = class(TForm)
    ...
    Label23: TLabel;
    Label24: TLabel;
    DI_TURNGEARDISENGAGED_: TShadowButton;
    DI_OVERSPEEDALARM_: TShadowButton;
    DI_LOPRESSALARM_: TShadowButton;
    DI_HTTEMPALARM_: TShadowButton;
    DI_EMERGENCYSTOP_: TShadowButton;
    DI_OMDSHUTDOWN_: TShadowButton;
    DI_PRELUBPRESSLOW_: TShadowButton;
    DI_STARTFAIL_: TShadowButton;
    ShadowButton9: TShadowButton;
    ShadowButton10: TShadowButton;
    DI_MAINBERGTEMPHIGHSHUTDOWN_: TShadowButton;
    DI_BOTHTACHOFAILSHUTDOWN_: TShadowButton;
    DI_COMMONSHUTDOWN_: TShadowButton;
    ShadowButton14: TShadowButton;
    Panel42: TPanel;
    Label1: TLabel;
    Label3: TLabel;
    Label4: TLabel;
    ...
    AI_EXH_A_7_L: TiLedBar;
    AI_EXH_A_8_L: TiLedBar;
    AI_EXH_A_9_L: TiLedBar;
    AI_EXH_B_1_L: TiLedBar;
    AI_EXH_B_2_L: TiLedBar;
    AI_EXH_B_3_L: TiLedBar;
    AI_EXH_B_5_L: TiLedBar;
    AI_EXH_B_4_L: TiLedBar;
    AI_EXH_B_6_L: TiLedBar;
    AI_EXH_B_7_L: TiLedBar;
    AI_EXH_B_8_L: TiLedBar;
    AI_EXH_B_9_L: TiLedBar;
    AI_MAINBERGTEMP_1_L: TiLedBar;
    AI_MAINBERGTEMP_2_L: TiLedBar;
    AI_MAINBERGTEMP_3_L: TiLedBar;
    AI_MAINBERGTEMP_5_L: TiLedBar;
    AI_MAINBERGTEMP_4_L: TiLedBar;
    AI_MAINBERGTEMP_6_L: TiLedBar;
    AI_MAINBERGTEMP_7_L: TiLedBar;
    AI_MAINBERGTEMP_8_L: TiLedBar;
    AI_MAINBERGTEMP_10_L: TiLedBar;
    AI_MAINBERGTEMP_9_L: TiLedBar;
    AI_EXH_TCINLET_A_L: TiLedBar;
    AI_EXH_A_Avg_L: TiLedBar;
    AI_EXH_TCINLET_B_L: TiLedBar;
    AI_EXH_B_Avg_L: TiLedBar;
    AI_MAINBERGTEMP_11_L: TiLedBar;
    ...
    AI_HTPRESSINLET_B: TiAnalogDisplay;
    StaticText29: TStaticText;
    AI_SLOWTURNAIRPRESS: TiAnalogDisplay;
    StaticText30: TStaticText;
    AI_LOTC_B_TEMP: TiAnalogDisplay;
    StaticText31: TStaticText;
    AI_NCOPRESS: TiAnalogDisplay;
    AI_EXH_TCOUTLET_A_L: TiLedBar;
    AI_EXH_TCOUTLET_B_L: TiLedBar;
    AI_EXH_A_1: TPanel;
    AI_EXH_A_2: TPanel;
    AI_EXH_A_3: TPanel;
    AI_EXH_A_4: TPanel;
    ...
    AI_EXH_A_7: TPanel;
    AI_EXH_A_8: TPanel;
    AI_EXH_TCOUTLET_A: TPanel;
    AI_EXH_TCINLET_A: TPanel;
    AI_EXH_A_Avg: TPanel;
    AI_EXH_A_9: TPanel;
    AI_EXH_B_1: TPanel;
    AI_EXH_B_2: TPanel;
    ...
    AI_EXH_B_9: TPanel;
    AI_EXH_B_Avg: TPanel;
    AI_EXH_TCINLET_B: TPanel;
    AI_EXH_TCOUTLET_B: TPanel;
    Panel10: TPanel;
    DI_PRELUBPRESSLOW: TShadowButton;
    DI_STARTFAIL: TShadowButton;
    ShadowButton18: TShadowButton;
    ShadowButton19: TShadowButton;
    DI_COMMONSHUTDOWN: TShadowButton;
    ShadowButton21: TShadowButton;
    Label20: TLabel;
    Label25: TLabel;
    DI_OVERSPEEDALARM: TShadowButton;
    DI_LOPRESSALARM: TShadowButton;
    DI_HTTEMPALARM: TShadowButton;
    DI_EMERGENCYSTOP: TShadowButton;
    DI_OMDSHUTDOWN: TShadowButton;
    DI_MAINBERGTEMPHIGHSHUTDOWN: TShadowButton;
    DI_BOTHTACHOFAILSHUTDOWN: TShadowButton;
    ShadowButton29: TShadowButton;
    DI_OVERSPEEDSHUTDOWN_C: TShadowButton;
    DI_SHUTDOWNSAFETY: TShadowButton;
    ShadowButton32: TShadowButton;
    DI_STOPFAIL: TShadowButton;
    DI_FUELLEAKAGENOHIGH: TShadowButton;
    DI_JETSYSFAIL: TShadowButton;
    DI_SAFETY_OMDFAIL: TShadowButton;
    DI_BASELUBLOW: TShadowButton;
    DI_BASELUBHIGH: TShadowButton;
    DI_OMDALARM: TShadowButton;
    DI_MONSYSFAIL: TShadowButton;
    DI_MONSENSORFAIL: TShadowButton;
    DI_FOPRESSINLETLOW: TShadowButton;
    DI_GOVFAULT: TShadowButton;
    DI_TACHOFAIL: TShadowButton;
    aaa: TShadowButton;
    DI_FOTEMPHIGH: TShadowButton;
    DI_HTPRESSLOW_A: TShadowButton;
    DI_STARTAIRLOW: TShadowButton;
    DI_HTTEMPHIGH: TShadowButton;
    DI_LOPRESSLOW: TShadowButton;
    DI_TCTEMPHIGH_A_A: TShadowButton;
    DI_TCTEMPHIGH_A_B: TShadowButton;
    DI_TCOUTLETTEMPHIGH_A: TShadowButton;
    DI_NCOPRESSLOW: TShadowButton;
    DI_SLOWTURNAIRPRESSLOW: TShadowButton;
    DI_DIFFFOFILTERHIGH: TShadowButton;
    Panel11: TPanel;
    Panel12: TPanel;
    Panel13: TPanel;
    Panel14: TPanel;
    ...
    Panel19: TPanel;
    Panel35: TPanel;
    DI_REMOTE: TShadowButton;
    DI_LOCAL: TShadowButton;
    DI_READYTOSTART: TShadowButton;
    ShadowButton15: TShadowButton;
    ShadowButton16: TShadowButton;
    DI_ENGINERUNNING: TShadowButton;
    StaticText5: TStaticText;
    AI_EXH_A_10: TiAnalogDisplay;
    StaticText6: TStaticText;
    AI_EXH_B_10: TiAnalogDisplay;
    AI_MAINBERGTEMP_1: TPanel;
    AI_MAINBERGTEMP_2: TPanel;
    AI_MAINBERGTEMP_5: TPanel;
    AI_MAINBERGTEMP_6: TPanel;
    AI_MAINBERGTEMP_7: TPanel;
    AI_MAINBERGTEMP_8: TPanel;
    AI_MAINBERGTEMP_9: TPanel;
    AI_MAINBERGTEMP_10: TPanel;
    AI_MAINBERGTEMP_11: TPanel;
    AI_MAINBERGTEMP_4: TPanel;
    AI_MAINBERGTEMP_3: TPanel;
    ...
    Panel3: TPanel;
    Panel4: TPanel;
    AI_EXH_TCINLET_A_L_: TiLedBar;
    AI_EXH_TCOUTLET_A_L_: TiLedBar;
    AI_EXH_TCINLET_A_: TPanel;
    AI_EXH_TCOUTLET_A_: TPanel;
    Panel9: TPanel;
    Panel20: TPanel;
    AI_EXH_TCINLET_B_L_: TiLedBar;
    AI_EXH_TCOUTLET_B_L_: TiLedBar;
    AI_EXH_TCINLET_B_: TPanel;
    AI_EXH_TCOUTLET_B_: TPanel;
    ...
    AI_GEN_U: TiAnalogDisplay;
    StaticText12: TStaticText;
    AI_GEN_V: TiAnalogDisplay;
    StaticText13: TStaticText;
    AI_GEN_W: TiAnalogDisplay;
    Panel5: TPanel;
    AI_MAINBERGTEMP_THRUST_L_: TiLedBar;
    AI_MAINBERGTEMP_THRUST_: TPanel;
  ...
  private
    ...
    procedure UpdateTrace_ECS_avat(var Msg: TEventData_ECS_avat); message WM_EVENT_ECS;
    ...
    procedure Value2Screen_ECS_avat(BlockNo: integer; AModbusMode: integer);
    procedure Value2Screen_Analog_ECS_avat(AName: string; AValue: Integer; AMaxVal: real; AModbusMode: integer);
    procedure Value2Screen_Analog1_ECS_avat(AName: string; AValue: Integer; AMaxVal: real; AModbusMode: integer);
    procedure Value2Screen_Analog2_ECS_avat(AName: string; AValue: Integer; AMaxVal: real; AModbusMode: integer);
    procedure Value2Screen_Analog3_ECS_avat(AName: string; AValue: Integer; AMaxVal: real; AModbusMode: integer);
    procedure Value2Screen_Digital_ECS_avat(Name: string; AValue: Integer;
                                    AMaxVal: real; AContact: integer);
    procedure Value2Screen_Digital1_ECS_avat(Name: string; AValue: Integer;
                                    AMaxVal: real; AContact: integer);
    procedure Value2Screen_Digital2_ECS_avat(Name: string; AValue: Integer;
                                    AMaxVal: real; AContact: integer);
...
procedure TFrmEngineMonitoring.ECS_OnSignal(Sender: TIPCThread_ECS_avat; Data: TEventData_ECS_avat);
var
  i,dcount: integer;
begin
...
begin
  FIPCMonitor_ECS_avat := TIPCMonitor_ECS_avat.Create(0, ECS_SHARE_NAME, True);
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  //kumo ECS를 Value2Screen_ECS_avat 함수에서 처리하기 위함
...
procedure TFrmEngineMonitoring.UpdateTrace_ECS_avat(var Msg: TEventData_ECS_avat);
var
  it: DIterator;
  pHiMap: THiMap;
  i, j, BlockNo: integer;
...
begin
  ...
  begin
    ...
    begin
      if FECSData.ModBusMode = 3 then //pHiMap에는 dummy가 존재함
      begin
        if UpperCase(pHiMap.FDescription) = 'DUMMY' then
        begin
          Advance(it);
          continue;
        end;

        //InpDataBuf_double에 dummy값이 존재하지 않음
        pHiMap.FValue := FECSData.InpDataBuf_double[i];
      end
      else
        pHiMap.FValue := FECSData.InpDataBuf[i]; //InpDataBuf에 dummy 값이 존재함
  ...
  //수신된 데이타를 화면에 뿌려줌
  Value2Screen_ECS_avat(BlockNo,FECSData.ModBusMode);
end;

procedure TFrmEngineMonitoring.Value2Screen_Analog1_ECS_avat(AName: string;
...
begin
  ...
  try
    ...
    begin
      ...
      else if System.Pos('AI_EXH_TC', AName) > 0 then//TC Inlet/Outlet Temp.
      begin
...
procedure TFrmEngineMonitoring.Value2Screen_Analog2_ECS_avat(AName: string;
  AValue: Integer; AMaxVal: real; AModbusMode: integer);
var
  LisPress: boolean;
  LComponent, LComponent2: TComponent;
...
begin
  ...
  try
    ...
    LComponent := FindComponent(AName+'_'); //1 Page와 구분하기 위함
    if Assigned(LComponent) then
    begin
      if AModbusMode = 3 then
        Le := AValue
...
procedure TFrmEngineMonitoring.Value2Screen_Analog3_ECS_avat(AName: string;
  AValue: Integer; AMaxVal: real; AModbusMode: integer);
var
  LisPress: boolean;
  LComponent, LComponent2: TComponent;
...
procedure TFrmEngineMonitoring.Value2Screen_Analog_ECS_avat(AName: string; AValue: Integer;
  AMaxVal: real; AModbusMode: integer);
begin
  case NxPageControl1.ActivePageIndex of
    1: Value2Screen_Analog1_ECS_avat( AName, AValue, AMaxVal, AModbusMode );
    2: Value2Screen_Analog2_ECS_avat( AName, AValue, AMaxVal, AModbusMode );
    3: Value2Screen_Analog3_ECS_avat( AName, AValue, AMaxVal, AModbusMode );
  end;
end;

//AContact: 1 = A접점, 2 = B접점, 3 = C접점
procedure TFrmEngineMonitoring.Value2Screen_Digital1_ECS_avat(Name: string; AValue: Integer;
  AMaxVal: real; AContact: integer);
var
  rslt: string;
  shbtn: TShadowButton;
...
procedure TFrmEngineMonitoring.Value2Screen_Digital2_ECS_avat(Name: string;
  AValue: Integer; AMaxVal: real; AContact: integer);
begin
  Value2Screen_Digital1_ECS_avat(Name+'_', AValue, AMaxVal, AContact);
end;

procedure TFrmEngineMonitoring.Value2Screen_Digital_ECS_avat(Name: string;
  AValue: Integer; AMaxVal: real; AContact: integer);
begin
  case NxPageControl1.ActivePageIndex of
    0: Value2Screen_Digital1_ECS_avat(Name, AValue, AMaxval, AContact);
    1: Value2Screen_Digital2_ECS_avat(Name, AValue, AMaxval, AContact);
  end;
end;

procedure TFrmEngineMonitoring.Value2Screen_ECS_avat(BlockNo: integer; AModbusMode: integer);
var
  it: DIterator;
  pHiMap: THiMap;
begin
  ...
  begin
    ...
    begin
      if pHiMap.FAlarm then
        Value2Screen_Analog_ECS_avat(pHiMap.FName ,pHiMap.FValue, pHiMap.FMaxval,FECSData.ModBusMode)
      else
        Value2Screen_Digital_ECS_avat(pHiMap.FName ,pHiMap.FValue, pHiMap.FMaxval, pHiMap.FContact);
    end;
