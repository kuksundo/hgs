...
uses Winsock, SysUtils, Classes, DataStruct4GasEngine;
...
function ReadEventDataFromStream(AStream:TStream):TEventData_IPCAll;
procedure WriteEventData2Stream(AEventData: TEventData_IPCAll; AStream:TStream);
