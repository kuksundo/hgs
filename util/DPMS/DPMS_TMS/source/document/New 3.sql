...
(    
    ...
    (
        SELECT A.PLAN_NO, TASK_NO, A.PRN, PLAN_NAME, ENG_MODEL, ENG_TYPE, ENG_PROJNO, PLAN_EMPNO, PLAN_TEAM, PLAN_START, PLAN_END FROM
        (            
            SELECT A.PLAN_NO, PRN, TASK_NO, PLAN_CODE, PLAN_TYPE, PLAN_NAME, ENG_MODEL, ENG_TYPE, ENG_PROJNO, PLAN_DRAFTER, PLAN_START, PLAN_END FROM
            (
