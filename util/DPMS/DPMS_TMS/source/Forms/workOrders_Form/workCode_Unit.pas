        ...
        begin
          ...
          try
            ...
            begin
              ...
              Close;
              SQL.Clear;
              SQL.Add('DELETE FROM DPMS_TMS_WORK_CODEGRP ' +
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                Close;
                SQL.Clear;
                SQL.Add('DELETE FROM DPMS_TMS_WORK_CODE ' +
                        'WHERE CODE LIKE :param1 ');
          ...
          begin
            ...
            begin
              Close;
              SQL.Clear;
              SQL.Add('UPDATE DPMS_TMS_WORK_CODE SET ' +
                      'SEQ_NO = :SEQ_NO ' +
                      'WHERE CODE LIKE :param1 ');
              ParamByName('param1').AsString := Cells[2,i];
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT CODE_NAME FROM DPMS_TMS_WORK_CODE ' +
        ...
        begin
          Close;
          SQL.Clear;
          SQL.Add('INSERT INTO DPMS_TMS_WORK_CODE ' +
                  '( ' +
...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('SELECT COUNT(*) COUNT FROM DPMS_TMS_WORK_CODE ');
      Open;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                '( ' +
                '   SELECT A.*, B.NAME_KOR FROM DPMS_TMS_WORK_CATEGORY A ' +
                '   LEFT OUTER JOIN DPMS_USER B ' +
  ...
  begin
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                '( ' +
                '   SELECT A.*, B.NAME_KOR FROM DPMS_TMS_WORK_CODE A ' +
                '   LEFT OUTER JOIN DPMS_USER B ' +
                '   ON A.DRAFTER = B.USERID ' +
                ') ' +
                'WHERE USE_YN = :param1 ' +
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                ...
                '   ( ' +
                '       SELECT A.*, B.CAT_NAME FROM DPMS_TMS_WORK_CODEGRP A, DPMS_TMS_WORK_CATEGORY B ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('INSERT INTO DPMS_TMS_WORK_CODEGRP ' +
                '( ' +
          ...
          try
            ...
            begin
              ...
              SQL.Add('DELETE FROM DPMS_TMS_WORK_ORDERS ' +
                      'WHERE CODE IN ' +
                      '( ' +
                      '   SELECT CAT_NO FROM DPMS_TMS_WORK_CATEGORY ' +
              ...
              Close;
              SQL.Clear;
              SQL.Add('DELETE FROM DPMS_TMS_WORK_CATEGORY ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('UPDATE DPMS_TMS_WORK_CATEGORY SET ' +
                'SEQ_NO = :SEQ_NO ' +
                'WHERE CAT_NO LIKE :param1 ');
        for i := 0 to RowCount-1 do
        begin
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('UPDATE DPMS_TMS_WORK_CODEGRP SET ' +
                'SEQ_NO = :SEQ_NO ' +
                'WHERE GRP_NO = :param1 ');
