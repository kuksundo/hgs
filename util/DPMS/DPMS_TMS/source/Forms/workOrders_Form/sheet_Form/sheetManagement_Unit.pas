...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('DELETE FROM DPMS_TMS_WORK_CODE_SHEET ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT A.*, B.SHEET_NAME_K FROM DPMS_TMS_WORK_CODE_SHEET A, DPMS_TMS_WORK_SHEET B ' +
                'WHERE CODE LIKE :param1 ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT * FROM DPMS_TMS_WORK_SHEET ');
        Open;
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('INSERT INTO DPMS_TMS_WORK_CODE_SHEET ' +
