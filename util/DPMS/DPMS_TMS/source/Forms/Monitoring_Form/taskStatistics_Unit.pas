  ...
  try
    ...
    begin
      ...
      SQL.Add('SELECT * FROM ' +
              ...
              '           ) A JOIN  ' +
              '           ( ' +
              '               SELECT * FROM DPMS_TMS_PLAN_INCHARGE ' +
              '           )B ' +
              '           ON A.PLAN_NO = B.PLAN_NO ' +
              '           AND A.PRN = B.PLAN_REV_NO ' +
              '       ) B ' +
...
begin
  ...
  begin
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('SELECT * FROM DPMS_TMS_ANNUAL_MH_COST ' +
              'WHERE YEAR = :param1 ');
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT TASK_NO, TASK_NAME, SUM(RST_MH) MH FROM ' +
                ...
                '               ) A JOIN ' +
                '               ( ' +
                '                   SELECT PLAN_NO, PLAN_REV_NO, PLAN_NAME FROM DPMS_TMS_PLAN ' +
                '               ) B ' +
                '               ON A.PN = B.PLAN_NO  ' +
                '               AND A.PRN = B.PLAN_REV_NO ' +
                '           ) B ' +
...
begin
  ...
  try
    ...
    begin
      ...
      SQL.Add('SELECT * FROM ' +
              '( ' +
              '   SELECT TASK_NO, TASK_NAME FROM DPMS_TMS_TASK ' +
              '   UNION ALL ' +
