    ...
    try
      ...
      try
        ...
        begin
          ...
          SQL.Add('SELECT ' +
                  '   A.*, ' +
                  '   (SELECT COUNT(*) FROM DPMS_TMS_ATTFILES WHERE OWNER LIKE A.PLAN_NO) FILECNT, ' +
                  ...
                  '           FROM     ' +
                  '           ( ' +
                  '               SELECT PLAN_NO, MAX(PLAN_REV_NO) PRN FROM DPMS_TMS_PLAN GROUP BY PLAN_NO ' +
                  '           ) A JOIN ' +
                  '           ( ' +
                  '               SELECT ' +
                  '                 A.*, B.CODE_NAME, C.NAME_KOR DRAFTER_NAME ' +
                  '               FROM DPMS_TMS_PLAN A, DPMS_CODE_GROUP B, DPMS_USER C ' +
                  ...
                  '               FROM DPMS_TMS_PLAN_INCHARGE A, DPMS_DEPT B  ' +
