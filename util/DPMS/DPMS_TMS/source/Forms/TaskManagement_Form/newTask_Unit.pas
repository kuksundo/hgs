    ...
    begin
      ...
      try
        ...
        begin
          ...
          Close;
          SQL.Clear;
          SQL.Add('DELETE FROM DPMS_TMS_TASK ' +
  ...
  begin
    ...
    begin
      ...
      try
        ...
        Cell[4, lrow].AsInteger := JvComboBox1.Tag;
      finally
        EndUpdate;
      end;
    end;
        ...
        try
          ...
          begin
            ...
            begin
              ...
              CellByName['TeamAlias',lrow].AsInteger := FieldByName('TASK_TEAM_ALIAS').AsInteger;
...
begin
  ...
  try
    if aTask_No <> '' then
    begin
      Query := 'SELECT NVL(MAX(TASK_ORDER)+1,1) ORDERS FROM DPMS_TMS_TASK WHERE TASK_PRT = :param1 ';
    end else
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('Insert Into DPMS_TMS_TASK ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('DELETE FROM DPMS_TMS_TASK_SHARE ' +
                'WHERE TASK_NO = :param1 ');
        ParamByName('param1').AsString := aTask_No;
        ExecSQL;
        ...
        begin
          Close;
          SQL.Clear;
          SQL.Add('INSERT INTO DPMS_TMS_TASK_SHARE ' +
                  'Values(:TASK_NO, :TASK_TEAM, :TASK_AUTHORITY, :TASK_SORT, :TASK_TEAM_ALIAS)');
          ...
          ParamByName('TASK_TEAM_ALIAS').AsInteger   := CellByName['TeamAlias', li].AsInteger;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        JvComboBox1.Tag := FieldByName('ALIAS_CODE').AsInteger;
        Break;
      end;
      Next;
    end;
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT A.*, B.ALIAS_CODE FROM DPMS_DEPT A, DPMS_DEPT_ALIAS B WHERE A.PARENT_CD = :param1 AND A.DEPT_CD = B.DEPT_CODE ');
        ParamByName('param1').AsString := DM1.FUserInfo.CurrentUsersDept;
        Open;

        while not eof do
        begin
          LDept := FieldByName('DEPT_CD').AsString;

          if not SameText(RightStr(LDept,1), '0') then
...
begin
  ...
  begin
    ...
    try
      ...
      Cells[3,lrow] := lTeam;
      CellByName['TeamAlias',lrow].AsInteger := DM1.GetAliasCode(lTeam);
    finally
      EndUpdate;
    end;
  end;
