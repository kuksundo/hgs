  ...
  begin
    ...
    begin
      try
        ...
        Close;
        SQL.Clear;
        SQL.Add('UPDATE DPMS_TMS_RESULT_MH SET ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT * FROM DPMS_CODE_GROUP ' +
                'WHERE CAT_NO = :param1 ' +
                'ORDER BY SEQ_NO ');
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT NAME_KOR, USERID FROM DPMS_USER ' +
                'WHERE GUNMU = :param1 ');
...
const
  Query   = 'SELECT * FROM ' +
            ...
            '           ) A, ' +
            '           ( ' +
            '               SELECT PLAN_NO, PLAN_REV_NO, SUBSTR(PLAN_TEAM,1,4) PLAN_TEAM, PLAN_TEAM TEAM FROM DPMS_TMS_PLAN_INCHARGE ' +
            '           ) B ' +
            ...
            '           FROM DPMS_TMS_PLAN A LEFT OUTER JOIN DPMS_CODE_GROUP B ' +
