...
begin
  ...
  const
    Query = 'SELECT * FROM' +
            ...
            '       TASK_TEAM, DRAFTER_NAME, MANAGER_NAME, TASK_TEAM_ALIAS ' +
            '    FROM ' +
            '    ( ' +
            '       SELECT ' +
            '         A.TASK_NO, TASK_PRT, TASK_LV, TASK_NAME, EXD_TASK_START, ' +
            ...
            '         TASK_INDATE, TASK_ORDER, TASK_STATE, TASK_TEAM, DRAFTER_NAME, TASK_TEAM_ALIAS ' +
            '       FROM ' +
            '       ( ' +
            '           SELECT ' +
            ...
            '             TASK_DRAFTER, TASK_INDATE, TASK_ORDER, TASK_STATE, TASK_TEAM, TASK_TEAM_ALIAS ' +
      ...
      try
        ...
        begin
          ...
          SQL.Add('SELECT * FROM ' +
                  ...
                  ') A INNER JOIN ' +
                  '( ' +
                  '   SELECT GRP_NO, CODE_NAME FROM DPMS_CODE_GROUP ' +
                  ') B ' +
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                ...
                '           ) A LEFT OUTER JOIN ' +
                '           ( ' +
                '               SELECT CODE_NAME, GRP_NO FROM DPMS_CODE_GROUP ' +
                '           ) B ' +
                '           ON A.PLAN_CODE = B.GRP_NO ' +
                '       ) B  ' +
                '       WHERE A.PLAN_NO = B.PLAN_NO  ' +
