  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('SELECT * FROM DPMS_HIMSEN_MS_PART ' + 'WHERE MS_NO LIKE :param1 '+
                'AND ENGTYPE = :ENGTYPE ');
    ...
    try
      ...
      try
        ...
        begin
          Close;
          SQL.Clear;
          SQL.Add('SELECT REQ_NO, PART_NO, SERIAL, FILE_NAME, FILE_SIZE FROM DPMS_TMS_TEST_PART_ATTFILES ' +
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('SELECT * FROM DPMS_TMS_TEST_PART_ATTFILES ' +
