...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('DELETE FROM DPMS_HIMSEN_MS_PART ' +
    ...
    SQL.Clear;
    SQL.Add('DELETE FROM DPMS_HIMSEN_MS_ATTFILES ' +
            'WHERE PART_NO LIKE :param1 ');
    ParamByName('param1').AsString  := et_PartNo.Text;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Close;
          SQL.Clear;
          SQL.Add('INSERT INTO DPMS_HIMSEN_MS_ATTFILES ( ' +
...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('SELECT NVL(MAX(REG_NO),0)+1 REG_NO FROM DPMS_HIMSEN_MS_ATTFILES ' +
...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('SELECT * FROM DPMS_HIMSEN_MS_PART ' + 'WHERE PART_NO LIKE :param1 ');
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('INSERT INTO DPMS_HIMSEN_MS_PART ' +
            '( ' +
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('UPDATE DPMS_HIMSEN_MS_PART SET ' +
