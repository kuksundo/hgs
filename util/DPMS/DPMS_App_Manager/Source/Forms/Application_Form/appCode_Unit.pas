...
procedure TappCode_Frm.Get_DPMS_APP_CODE;
begin
  TThread.Queue(nil,
  procedure
  var
      ...
      try
        ...
        begin
          ...
          begin
            Close;
            SQL.Clear;
            SQL.Add('SELECT SORTNO FROM DPMS_APP_CODE ' +
                    'WHERE APPTYPE = :param1 ');
            ParamByName('param1').AsString := ra_appType.Items.Strings[ra_appType.ItemIndex];
            Open;
            ...
            Close;
            SQL.Clear;
            SQL.Add('INSERT INTO DPMS_APP_CODE ' +
                    'VALUES( ' +
            ...
            ParamByName('REGID').AsString := 'A379042';
...
begin
  ...
  begin
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('UPDATE DPMS_APP_CODE SET ' +
