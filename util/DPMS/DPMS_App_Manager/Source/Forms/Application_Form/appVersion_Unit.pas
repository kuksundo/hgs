...
type
  ...
  public
    { Public declarations }
    procedure Get_DPMS_APP_CODE;
    procedure Get_DPMS_APP_VERSION;
  ...
  begin
    ...
    begin
      try
        Close;
        SQL.Clear;
        SQL.Add('DELETE FROM DPMS_APP_VERSION ' +
                'WHERE VERNO = :param1 ');
...
procedure TappVersion_Frm.Get_DPMS_APP_CODE;
begin
  TThread.Queue(nil,
  procedure
  var
...
procedure TappVersion_Frm.Get_DPMS_APP_VERSION;
begin
  TThread.Queue(nil,
  procedure
  var
      ...
      try
        ...
        begin
          ...
          SQL.Add('SELECT ' +
                  ...
                  'FROM DPMS_APP_CODE A, DPMS_APP_VERSION B ' +
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM DPMS_APP_VERSION ' +
                'WHERE VERNO = (SELECT MAX (VERNO) FROM DPMS_APP_VERSION) ');
        Open;
        ...
        try
          ...
          FieldbyName('REGID').AsString    := 'A379042';
