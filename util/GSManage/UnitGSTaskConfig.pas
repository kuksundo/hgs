...
uses
  ...
  JvExMask, JvToolEdit, AdvOfficePager,
  NxEdit, UnitSelectUser;

type
  TGSTaskConfigF = class(TForm)
...
var
  GSTaskConfigF: TGSTaskConfigF;

implementation

{$R *.dfm}

procedure TGSTaskConfigF.LowFaultEnableCBClick(Sender: TObject);
begin
...
procedure TGSTaskConfigF.DigitalValue2Form(
...
procedure TGSTaskConfigF.DigitalValueFromForm(
  AEPItem: TEngineParameterItem);
begin
  //Digital Type은 MinAlarm* 변수를 사용함
...
procedure TGSTaskConfigF.DisableOtherAlarmConfigUI(
...
procedure TGSTaskConfigF.LimitValue2Form(
  AEPItem: TEngineParameterItem);
begin
...
procedure TGSTaskConfigF.LimitValueFromForm(
  AEPItem: TEngineParameterItem);
begin
  with AEPItem do
  begin
...
procedure TGSTaskConfigF.LoadConfigEngParamItem2Form(
  AEPItem: TEngineParameterItem);
var
  LStr: string;
begin
...
function TGSTaskConfigF.LoadConfigForm2EngParamItem(AEP: TEngineParameter;
  AEPItem: TEngineParameterItem): integer;
//var
...
procedure TGSTaskConfigF.LowAlarmEnableCBClick(Sender: TObject);
begin
...
procedure TGSTaskConfigF.MaxFaultEnableCBClick(Sender: TObject);
begin
...
procedure TGSTaskConfigF.MaxFaultSoundCBClick(Sender: TObject);
begin
  MaxFaultSoundEdit.Enabled := MaxFaultSoundCB.Checked;
end;

procedure TGSTaskConfigF.MinAlarmSoundCBClick(Sender: TObject);
begin
  MinAlarmSoundEdit.Enabled := MinAlarmSoundCB.Checked;
end;

procedure TGSTaskConfigF.MinFaultSoundCBClick(Sender: TObject);
begin
  MinFaultSoundEdit.Enabled := MinFaultSoundCB.Checked;
end;

procedure TGSTaskConfigF.RecipientsEditButtonClick(Sender: TObject);
var
  LResult: string;
begin
...
procedure TGSTaskConfigF.MaxAlarmEnableCBClick(Sender: TObject);
begin
...
procedure TGSTaskConfigF.MaxAlarmSoundCBClick(Sender: TObject);
begin
