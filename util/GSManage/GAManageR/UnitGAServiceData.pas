...
type
  ...
  TGAServiceCharge = (gascNull, gascFree, gascPaid, gascFinal);

  TGAServiceType = (gastNull, gastTrainingTravel, gastTrainingInHouse,
    gastTrainingOnline, gastVDRAPT, gastFinal);
...
const
  ...
  R_GAServiceCharge : array[Low(TGAServiceCharge)..High(TGAServiceCharge)] of string =
    (
    '',
    'Free',
    'Paid',
  ...
  R_GAServiceType : array[Low(TGAServiceType)..High(TGAServiceType)] of string =
    (
    '',
    'Training(Travel)',
    'Training(In-House)',
...
var
  ...
  g_GAServiceCharge: TLabelledEnum<TGAServiceCharge>;
  g_GAServiceType: TLabelledEnum<TGAServiceType>;
...
initialization
  ...
  g_GAServiceCharge.InitArrayRecord(R_GAServiceCharge);
  g_GAServiceType.InitArrayRecord(R_GAServiceType);
