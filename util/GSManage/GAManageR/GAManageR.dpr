...
uses
  ...
  FrmGAManage in 'FrmGAManage.pas' {InquiryF},
  UViewMailList in '..\UViewMailList.pas' {ViewMailListF},
  UnitGAMasterRecord in 'UnitGAMasterRecord.pas',
  FrmGATaskEdit in 'FrmGATaskEdit.pas' {TaskEditF},
  ...
  UnitGAServiceData in 'UnitGAServiceData.pas',
  UnitGAVarJsonUtil in 'UnitGAVarJsonUtil.pas',
  UnitGAMakeReport in 'UnitGAMakeReport.pas',
  UnitIniConfigSetting in '..\UnitIniConfigSetting.pas',
  UnitInqManageWSInterface in '..\UnitInqManageWSInterface.pas',
  FrmSubCompanyEdit in '..\FrmSubCompanyEdit.pas',
