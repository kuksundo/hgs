            ...
            begin
              ...
              begin
                ...
                begin
                  Close;
                  SQL.Clear;
                  SQL.Add('SELECT * from HiTEMS_USER A, HITEMS_USER_GRADE B ' +
    ...
    begin
      ...
      try
        ...
        begin
          Close;
          SQL.Clear;
          SQL.Add('DELETE FROM TMS_PLAN_INCHARGE ' +
                  'WHERE PLAN_NO = :param1 ' +
                  'AND PLAN_REV_NO = :param2 ');
          ParamByName('param1').AsString  := aPlanNo;
          ...
          begin
            Close;
            SQL.Clear;
            SQL.Add('INSERT INTO TMS_PLAN_INCHARGE ' +
...
begin
  ...
  try
    ...
    begin
      ...
      if not Check_Authority_of_addTask(taskNo.Hint,lCurrentTeam) = True then
      begin
...
procedure TnewTaskPlan_Frm.Send_Message_Main_CODE(FFlag, FSendID, FRecID, FHead,
...
//  lhead := '123456780123456789012';
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('SELECT REQ_ID FROM TMS_TEST_REQUEST WHERE REQ_NO LIKE ' +
  ...
  begin
    ...
    try
      ...
      begin
        Close;
        SQL.Clear;
        SQL.Add('select PROJNO, ENGTYPE, ENGMODEL from HIMSEN_INFO ' +
                'where STATUS = 0 ' +
                'AND ENGMODEL = :param1 ' +
    ...
    try
      ...
      begin
        ...
        begin
          Close;
          SQL.Clear;
          SQL.Add('select PROJNO, ENGMODEL, ENGTYPE from HIMSEN_INFO ' +
                  'where PROJNO = :param1 ');
