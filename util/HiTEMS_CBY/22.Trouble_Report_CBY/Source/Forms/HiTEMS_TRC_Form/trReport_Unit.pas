...
//        submitBtn.Enabled := True;
      ...
      begin
        if FieldByName('INFORMER').AsString = CurrentUsers then
        begin
          regBtn.Caption := '수정하기';
        end else
        begin

        //제보된 상태에서 작성자가 수정할 수 있도록
          Close;
          SQL.Clear;
        ...
        try
          ...
          begin
            ...
            try
              ...
              ParamByName('TRSTATE').AsInteger          := 1;
...
begin
  typeCode.Clear;
  typeName.Clear;
  case trType.ItemIndex of
    0..2 :
    begin
      typeCode.ReadOnly := True;
      typeName.ReadOnly := True;
      AdvGlowButton1.Enabled := True;
    end;
    3 :
    begin
      typeCode.ReadOnly := False;
