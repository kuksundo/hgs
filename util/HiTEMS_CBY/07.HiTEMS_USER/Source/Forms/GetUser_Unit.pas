...
//HiTEMS_User Table에 영문 이름 및 전화번호만 업데이트 함
...
//        Close;
//        SQL.Clear;
//        SQL.Add('select A.CLASS_, A.DESCR, B.DEPTNO, B.DESCR from HITEMS_EMPLOYEE_CLASS A, DEPTNO B ');
