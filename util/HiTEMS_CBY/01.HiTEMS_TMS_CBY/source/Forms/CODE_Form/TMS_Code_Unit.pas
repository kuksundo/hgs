...
var
  TMS_Code_Frm: TTMS_Code_Frm;
  function Create_TMS_Code_Frm:Boolean;
...
begin
  Result := False;
  TMS_Code_Frm := TTMS_Code_Frm.Create(nil);
  try
    with TMS_Code_Frm do
    begin
      FChanged := False;
    ...
    FreeAndNil(TMS_Code_Frm);
  end;
end;

procedure TTMS_Code_Frm.btn_AddClick(Sender: TObject);
var
  i,j,
  LRow : Integer;
  msg : String;
...
procedure TTMS_Code_Frm.btn_CheckClick(Sender: TObject);
var
  i : Integer;
  LGroupNo:String;
begin
...
procedure TTMS_Code_Frm.btn_CloseClick(Sender: TObject);
begin
  Close;
end;

procedure TTMS_Code_Frm.btn_DelClick(Sender: TObject);
var
  i,
  LRow : Integer;
  LGrpNo : String;
...
procedure TTMS_Code_Frm.btn_DelCodeClick(Sender: TObject);
var
  i : Integer;
  LResult : Boolean;
begin
...
procedure TTMS_Code_Frm.btn_DownClick(Sender: TObject);
var
  i : Integer;
  LToRow,
  LFromRow : Integer;
...
procedure TTMS_Code_Frm.btn_UpClick(Sender: TObject);
var
  i,
  LToRow,
  LFromRow : Integer;
...
procedure TTMS_Code_Frm.et_filterChange(Sender: TObject);
var
  i: Integer;
  s: string;
  RowVisible: Boolean;
...
procedure TTMS_Code_Frm.AeroButton4Click(Sender: TObject);
var
  LCode : String;
begin
    ...
    try
      ...
      begin
        ...
        begin
          ...
          ParamByName('DRAFTER').AsString   := CurrentUsers;
...
function TTMS_Code_Frm.Get_CodeSeqNo: Integer;
var
  OraQuery : TOraQuery;
begin
...
procedure TTMS_Code_Frm.Get_WorkCategory;
var
  i,
  LRow : Integer;
begin
  ...
  begin
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                '( ' +
                '   SELECT A.*, B.NAME_KOR FROM INTEGRATED_CODE_PATH A ' +
                '   LEFT OUTER JOIN HITEMS_USER B ' +
                '   ON A.DRAFTER = B.USERID ' +
                ') ' +
                'START WITH PARENT_CODE IS NULL ' +
                'CONNECT BY PRIOR PATH_CODE = PARENT_CODE ' +
                'ORDER SIBLINGS BY PATH_SEQ ');
        Open;
        ...
        begin
          ...
          begin
            if FieldByName('PARENT_CODE').AsString <> '' then
            begin
              for i := 0 to RowCount-1 do
              begin
                if Cells[2,i] = FieldByName('PARENT_CODE').AsString then
                begin
          ...
          Cells[1,LRow] := FieldByName('PATH_NAME').AsString;
          Cells[2,LRow] := FieldByName('PATH_CODE').AsString;
          Cells[3,LRow] := FieldByName('PARENT_CODE').AsString;
          Cell[4,LRow].AsInteger := FieldByName('PATH_LV').AsInteger;
          Cell[5,LRow].AsInteger := FieldByName('PATH_SEQ').AsInteger;
...
//            Cell[6,LRow].AsInteger := 1;
          ...
          Cell[7,LRow].AsInteger := FieldByName('PATH_LV').AsInteger;
...
procedure TTMS_Code_Frm.Get_WorkCode;
var
  LRow : Integer;
begin
  with grid_Code do
  begin
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                '( ' +
                '   SELECT A.*, B.NAME_KOR FROM INTEGRATED_CODE_LIST A ' +
                '   LEFT OUTER JOIN HITEMS_USER B ' +
                '   ON A.DRAFTER = B.USERID ' +
                ') ' +
                'ORDER BY CODE_SEQ ');
        ...
        begin
          ...
          Cell[4,LRow].AsInteger := FieldByName('CODE_SEQ').AsInteger;
...
procedure TTMS_Code_Frm.Get_WorkCodeGroup(aCatNo: String);
var
  LRow : Integer;
begin
  with grid_Group do
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                ...
                '   ( ' +
                '       SELECT A.*, B.PATH_NAME FROM INTEGRATED_CODE A, INTEGRATED_CODE_PATH B ' +
                '       WHERE A.PATH_CODE = :param1 ' +
        ...
        begin
          ...
          Cells[3,LRow] := FieldByName('PATH_CODE').AsString;
          Cells[4,LRow] := FieldByName('CODE').AsString;
          Cells[5,LRow] := FieldByName('INT_CODE').AsString;
          Cells[6,LRow] := FieldByName('NAME_KOR').AsString;
          Next;
        end;
      end;
...
procedure TTMS_Code_Frm.grid_CatMouseDown(Sender: TObject;
...
procedure TTMS_Code_Frm.grid_CatSelectCell(Sender: TObject; ACol,
  ARow: Integer);
var
  i : Integer;
begin
...
procedure TTMS_Code_Frm.grid_CodeCellDblClick(Sender: TObject; ACol,
  ARow: Integer);
begin
  et_codeName.Text := grid_Code.Cells[3,ARow];
end;

procedure TTMS_Code_Frm.grid_CodeSelectCell(Sender: TObject; ACol,
  ARow: Integer);
begin
  with grid_Code do
  begin
...
procedure TTMS_Code_Frm.grid_GroupCellDblClick(Sender: TObject; ACol,
  ARow: Integer);
begin
  if ARow = -1 then
    Exit;
...
procedure TTMS_Code_Frm.grid_GroupSelectCell(Sender: TObject; ACol,
  ARow: Integer);
begin
  with grid_Group do
  begin
...
procedure TTMS_Code_Frm.Insert_TMS_WORK_CODEGRP(aRow:Integer);
var
  i : Integer;
  LGroupNo:String;
begin
...
procedure TTMS_Code_Frm.menu_CatDelClick(Sender: TObject);
var
  i,
  LRow : Integer;
  LCatNo : String;
...
procedure TTMS_Code_Frm.menu_CatEditClick(Sender: TObject);
var
  i : Integer;
  LParentNo : String;
begin
...
procedure TTMS_Code_Frm.menu_NewCatClick(Sender: TObject);
var
  i : Integer;
begin
  with grid_Cat do
...
procedure TTMS_Code_Frm.Update_CodeGroup_SeqNo;
var
  i : Integer;
begin
  with grid_Group do
...
procedure TTMS_Code_Frm.Update_WorkCodeGroupSeqNo(aGrpNo: String;
  aValue: Integer);
begin
  with DM1.OraQuery1 do
  begin
