  ...
  begin
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                '( ' +
                '   SELECT A.*, B.CODE_NAME FROM TMS_RESULT A LEFT OUTER JOIN INTEGRATED_CODE B ' +
...
const
  Query   = 'SELECT * FROM ' +
            ...
            '           ) A, ' +
            '           ( ' +
            '               SELECT PLAN_NO, PLAN_REV_NO, SUBSTR(PLAN_TEAM,1,4) PLAN_TEAM FROM TMS_PLAN_INCHARGE ' +
            '           ) B ' +
            ...
            '           FROM TMS_PLAN A LEFT OUTER JOIN INTEGRATED_CODE B ' +
