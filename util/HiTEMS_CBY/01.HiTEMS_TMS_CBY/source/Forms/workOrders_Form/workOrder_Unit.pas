    ...
    begin
      ...
      try
        ...
        begin
          ...
          SQL.Add('SELECT ' +
                  '   A.*, ' +
                  '   (SELECT ENGTYPE FROM HIMSEN_INFO WHERE PROJNO LIKE A.ENG_PROJNO) ENG_TYPE ' +
                  'FROM ' +
                  '( ' +
      ...
      begin
        ...
        try
          ...
          begin
            Close;
            SQL.Clear;
            SQL.Add('SELECT * FROM TMS_ATTFILES ' + 'WHERE OWNER LIKE :param1 '
              + 'ORDER BY REGNO ');
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' + '( ' + '   SELECT * FROM ' + '   ( ' +
          ...
          '           FROM TMS_PLAN ' + '           WHERE PLAN_NO = :param1 ' +
          '           AND PLAN_REV_NO = :param2 ' + '       ) union all ' +
          '       ( ' +
          '           SELECT TASK_PRT, TASK_NO, TASK_NAME FROM TMS_TASK ' +
...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('SELECT MAX(SEQ_NO) SEQ FROM TMS_WORK_RESULT ' +
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT A.*, B.CODE_NAME FROM ' + '( ' +
          '   SELECT * FROM TMS_WORK_ORDERS ' + ') A, ' + '( ' +
          '   SELECT CAT_NO, CAT_NAME CODE_NAME FROM TMS_WORK_CATEGORY UNION ALL '
          + '   SELECT GRP_NO, CODE_NAME FROM TMS_WORK_CODEGRP ' + ') B ' +
...
begin
  ...
  begin
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('select * from TMS_ATTFILES ' + 'where REGNO = :param1 ');
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('INSERT INTO TMS_WORK_RESULT ' +
  ...
  try
    ...
    begin
      ...
      SQL.Add('SELECT A.*, B.ENG_PROJNO, B.ENG_TYPE FROM ' +
              ...
              '   WHERE CODE IN ( ' +
              '     SELECT CODE FROM TMS_WORK_CODEGRP ' +
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('SELECT PLAN_EMPNO FROM TMS_PLAN_INCHARGE ' +
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('UPDATE TMS_WORK_RESULT SET ' +
...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('UPDATE TMS_WORK_ORDERS SET ' + 'STATUS = :param1 ' +
