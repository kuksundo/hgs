  ...
  begin
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                '( ' +
                '   SELECT A.CODE, CODE_NAME, ORDER_NO, B.CODE SCODE FROM TMS_WORK_ORDERS A, TMS_WORK_CODEGRP B ' +
                '   WHERE A.CODE = B.GRP_NO ' +
                '   AND A.ORDER_NO = :param1 ' +
                ') A LEFT OUTER JOIN TMS_WORK_RESULT B ' +
    ...
    try
      ...
      begin
        ...
        SQL.Add('SELECT * FROM ' +
                ...
                '   FROM TMS_WORK_ORDERS A, TMS_WORK_CODEGRP B ' +
                '   WHERE A.CODE = B.GRP_NO ' +
                ') A, TMS_WORK_RESULT B ' +
...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Add('SELECT * FROM TMS_WORK_CODE_SHEET ' +
