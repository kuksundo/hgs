...
type
  ...
  TCustomLogicControl<T> = class(TGraphicControl)
  private
    ...
    FDrawPanel: T;//TCustomLogicPanel;
    FConnectors: TList;
  ...
  protected
    ...
    function GetCheckDrawPanel: T;//TCustomLogicPanel;
    property CheckDrawPanel: T {TCustomLogicPanel} read GetCheckDrawPanel;
    procedure Paint; override;
  ...
  public
    ...
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    property DrawPanel: T {TCustomLogicPanel} read FDrawPanel;
  ...
  TCustomLogicNodeBase = class(TCustomLogicControl<TCustomLogicForm>)
  protected
    procedure SetParent(AParent: TWinControl); override;
  end;
