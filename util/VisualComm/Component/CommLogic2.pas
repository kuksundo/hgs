...
begin
  ...
  begin
    ...
    spLL:
      begin
        ...
        begin
          Lines[dmSecondHandle] := Point(Lines[dmFirstHandle].x, p2.y);
          Lines[dmThirdHandle] := Point(Lines[dmFirstHandle].x, p2.y);
        end
        else //(-,-)
        begin
  ...
  begin
    ...
    spLL:
      begin
        Lines[dmSecondHandle] := Point(Lines[dmFirstHandle].x, p1.y + r1.Height)
        Lines[dmThirdHandle] := Point(Lines[dmLastHandle].x, p1.y + r1.Height)
      end;
    end;//case
  end;
