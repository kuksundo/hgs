...
type
  ...
  private
    ...
    FParser: TParser;
  protected
    // Method of the new function, which simply returns number 3:
    function ThreeMethod(const AFunction: PFunction; const AType: PType): TValue; virtual;
  public
...
begin
  ...
  FParser.AddFunction('Three', FTripleHandle, fkMethod,
    FunctionMethod(ThreeMethod), True, False, vtDouble);
...
function TMain.ThreeMethod(const AFunction: PFunction; const AType: PType): TValue;
begin
  {
