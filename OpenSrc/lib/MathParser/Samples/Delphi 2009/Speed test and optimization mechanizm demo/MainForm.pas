...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls, Parser, ParseTypes, ValueTypes;
...
type
  ...
  public
    procedure Status(Script: TScript; TickCount: Double = 0; Detailed: Boolean = False);
...
begin
  ...
  begin
    try
      ...
      FParser.Optimize;
      meOptimalItems.Lines.Add(Format(NumberMessage, [I + 1,
        FParser.ScriptToString(TypeMode)]));
    except
...
procedure TMain.Status(Script: TScript; TickCount: Double; Detailed: Boolean);
const
  Thousand = 1000;
var
  I: Integer;
