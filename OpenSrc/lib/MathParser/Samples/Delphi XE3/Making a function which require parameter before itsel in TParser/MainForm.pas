...
begin
  ...
  FParser.AddFunction('Triple', FTripleHandle, fkMethod,
    FunctionMethod(TripleMethod, True, False), True, False, vtDouble);

  {
    FunctionMethod here needs three parameters:
      - Method: TripleMethod (function method),
      - LParameter: defines that function "Triple" requires parameter from left;
      - RParameter: defines that function "Triple" does not require parameter
        from right.
  }
end;
