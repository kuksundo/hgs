...
type
  ...
  TReConnectReqEvent = procedure (Sender: TObject) of object;
  TPingRegProc = procedure of object;
  TSubscribeProc = procedure(Topic: Ansistring; RequestQoS: integer) of object;
  TUnSubscribeProc = procedure(Topic: Ansistring) of object;
...
begin
  ...
  //1시간 동안 ping이 없으면 접속 해제
  Self.FKeepAlive := 3600;//10; Sec,
end;
