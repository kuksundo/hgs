...
// dkWideStringUtils 1.0.9
// Delphi 4 to XE2 and Kylix 3 Implementation
// January 2012
//
//
// LICENSE
...
type
  ...
  TUtilsWideStringItemList = array[0..MaxInt div SizeOf(TUtilsWideStringItem) - 1] of TUtilsWideStringItem;
{$IFDEF CLR}
