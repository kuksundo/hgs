...
uses
  // code from philo.de
  dkCodecUtilsWin32, dkEncodingUtils,
  SysUtils, NativeXml;
...
const
  ...
  ( (Name: 'IBM037';                  Codepage:    37; Codec: TIBM037Codec), //1
    ...
    (Name: 'ASMO-449+';               Codepage:   709; Codec: nil),
    (Name: 'BCON V4';                 Codepage:   709; Codec: nil),
    (Name: 'Arabic';                  Codepage:   710; Codec: nil),
    (Name: 'DOS-720';                 Codepage:   720; Codec: nil),
    ...
    (Name: 'gb2312';                  Codepage:   936; Codec: nil),
    (Name: 'ks_c_5601-1987';          Codepage:   949; Codec: nil),
    (Name: 'big5';                    Codepage:   950; Codec: nil),
    ...
    (Name: 'Johab';                   Codepage:  1361; Codec: nil),
    (Name: 'macintosh';               Codepage: 10000; Codec: TMacLatin2Codec),  //guess, maybe also TMacRomanCodec
    (Name: 'x-mac-japanese';          Codepage: 10001; Codec: nil),
    (Name: 'x-mac-chinesetrad';       Codepage: 10002; Codec: nil),
    (Name: 'x-mac-korean';            Codepage: 10003; Codec: nil),
    (Name: 'x-mac-arabic';            Codepage: 10004; Codec: nil),
    (Name: 'x-mac-hebrew';            Codepage: 10005; Codec: nil),
    (Name: 'x-mac-greek';             Codepage: 10006; Codec: TMacGreekCodec),
    (Name: 'x-mac-cyrillic';          Codepage: 10007; Codec: TMacCyrillicCodec),
    (Name: 'x-mac-chinesesimp';       Codepage: 10008; Codec: nil),
    (Name: 'x-mac-romanian';          Codepage: 10010; Codec: nil),
    (Name: 'x-mac-ukrainian';         Codepage: 10017; Codec: nil),
    (Name: 'x-mac-thai';              Codepage: 10021; Codec: nil),
    (Name: 'x-mac-ce';                Codepage: 10029; Codec: nil),
    (Name: 'x-mac-icelandic';         Codepage: 10079; Codec: TMacIcelandicCodec),
    (Name: 'x-mac-turkish';           Codepage: 10081; Codec: TMacTurkishCodec),
    (Name: 'x-mac-croatian';          Codepage: 10082; Codec: nil),
    (Name: 'utf-32';                  Codepage: 12000; Codec: TUCS4_3412Codec),  //guess
    (Name: 'utf-32BE';                Codepage: 12001; Codec: TUCS4_2143Codec),  //guess
    (Name: 'x-Chinese_CNS';           Codepage: 20000; Codec: nil),
    (Name: 'x-cp20001';               Codepage: 20001; Codec: nil),
    (Name: 'x_Chinese-Eten';          Codepage: 20002; Codec: nil),
    (Name: 'x-cp20003';               Codepage: 20003; Codec: nil),
    (Name: 'x-cp20004';               Codepage: 20004; Codec: nil),
    (Name: 'x-cp20005';               Codepage: 20005; Codec: nil),
    (Name: 'x-IA5';                   Codepage: 20105; Codec: nil),
    (Name: 'x-IA5-German';            Codepage: 20106; Codec: nil),
    (Name: 'x-IA5-Swedish';           Codepage: 20107; Codec: nil),
    (Name: 'x-IA5-Norwegian';         Codepage: 20108; Codec: nil),
    (Name: 'us-ascii';                Codepage: 20127; Codec: TUSASCIICodec),
    (Name: 'x-cp20261';               Codepage: 20261; Codec: nil),
    (Name: 'x-cp20269';               Codepage: 20269; Codec: nil),
    (Name: 'IBM273';                  Codepage: 20273; Codec: TIBM273Codec),
    (Name: 'IBM277';                  Codepage: 20277; Codec: TIBM277Codec),
    (Name: 'IBM278';                  Codepage: 20278; Codec: nil),
    ...
    (Name: 'IBM-Thai';                Codepage: 20838; Codec: nil),
    ...
    (Name: 'IBM00924';                Codepage: 20924; Codec: nil),
    (Name: 'EUC-JP';                  Codepage: 20932; Codec: nil),
    (Name: 'x-cp20936';               Codepage: 20936; Codec: nil),
    (Name: 'x-cp20949';               Codepage: 20949; Codec: nil),
    (Name: 'cp1025';                  Codepage: 21025; Codec: nil),
    (Name: 'koi8-u';                  Codepage: 21866; Codec: nil),
    ...
    (Name: 'x-Europa';                Codepage: 29001; Codec: nil),
    (Name: 'iso-8859-8-i';            Codepage: 38598; Codec: TISO8859_8Codec), //guess
    (Name: 'iso-2022-jp';             Codepage: 50220; Codec: nil),
    (Name: 'csISO2022JP';             Codepage: 50221; Codec: nil),
    (Name: 'iso-2022-jp';             Codepage: 50222; Codec: nil),
    (Name: 'iso-2022-kr';             Codepage: 50225; Codec: nil),
    (Name: 'x-cp50227';               Codepage: 50227; Codec: nil),
    (Name: 'euc-jp';                  Codepage: 51932; Codec: nil),
    (Name: 'EUC-CN';                  Codepage: 51936; Codec: nil),
    (Name: 'euc-kr';                  Codepage: 51949; Codec: nil),
    (Name: 'hz-gb-2312';              Codepage: 52936; Codec: nil),
    (Name: 'GB18030';                 Codepage: 54936; Codec: nil),
    (Name: 'x-iscii-de';              Codepage: 57002; Codec: nil),
    (Name: 'x-iscii-be';              Codepage: 57003; Codec: nil),
    (Name: 'x-iscii-ta';              Codepage: 57004; Codec: nil),
    (Name: 'x-iscii-te';              Codepage: 57005; Codec: nil),
    (Name: 'x-iscii-as';              Codepage: 57006; Codec: nil),
    (Name: 'x-iscii-or';              Codepage: 57007; Codec: nil),
    (Name: 'x-iscii-ka';              Codepage: 57008; Codec: nil),
    (Name: 'x-iscii-ma';              Codepage: 57009; Codec: nil),
    (Name: 'x-iscii-gu';              Codepage: 57010; Codec: nil),
    (Name: 'x-iscii-pa';              Codepage: 57011; Codec: nil),
    (Name: 'utf-7';                   Codepage: 65000; Codec: nil),
...
begin
  ...
  if CodePage = 65001 then
    // utf-8
    Result := sdWideToUtf8Buffer(lpWideCharStr^, lpMultiByteStr^, cchWideChar, LastChar0D)
  else
  begin
    CodecClass := nil;
    for i := 0 to cCodepageToEncodingInfoCount - 1 do
