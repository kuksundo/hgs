...
uses
  ...
  Dialogs, StdCtrls, Buttons, ShellAPI, VssDockForm, UVssProgressForm;
...
var Entry:TPlaylistEntry; drivestring :array[0..3]of Ansichar;
  URLError : TOpenError;
  driveType : Cardinal;
begin
...
begin
 with PlaylistBox.Canvas do begin
  (*logform.AddLine(inttostr(Index) + ' ' + inttostr(rect.Left) + ' '
                                        + inttostr(rect.right) + ' '
                                        + inttostr(rect.top) + ' '
