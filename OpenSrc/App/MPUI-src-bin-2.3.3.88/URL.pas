...
const
      PlayableExtensionsA : array[1..9] of string = (
        'wav','mp1','mp2','mp3','mpa','ogg','wma','ac3','m4a'
      );
      PlayableExtensionsV :array[1..24] of string = (
        'avi','divx','mpg','mpeg','vob','dat','bin','mpe','pva','mpv','m1v','m2v',
        'ogm','mkv','wmv','asf','mov','qt','dv','m4v','26l','264','jsv','flv'
      );
