...
type
  ...
  published
    property ShowEstimatedTime: boolean Read FShowEstimatedTime
      Write FShowEstimatedTime;
  end;
...
begin
  ...
  begin
    ...
    if Assigned(FTaskbarList3) then
      FTaskbarList3.SetProgressValue(FTaskBarFormHandle, progressNormal.Position,
        progressNormal.Max);
  end;
  Application.ProcessMessages;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        EstimatedTime :=
          EstimatedTime + FormatDateTime('h "hour "', AEstimatedTime);
      end
      else
      begin
        EstimatedTime :=
          EstimatedTime + FormatDateTime('h "hours "', AEstimatedTime);
      end;
    end;
    ...
    begin
      ...
      begin
        EstimatedTime :=
          EstimatedTime + FormatDateTime('n "minute "', AEstimatedTime);
      end
      else
      begin
        EstimatedTime :=
          EstimatedTime + FormatDateTime('n "minutes "', AEstimatedTime);
      end;
    end;
