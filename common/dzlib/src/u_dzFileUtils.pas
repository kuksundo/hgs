...
//      const _Ext: string = '.tmp'): string;
    ...
    class function MakeValidFilename(const _s: string; _ReplaceChar: Char = '_'): string;

    class function ContainsWildcard(const _Mask: string): Boolean;

    /// <summary>
    /// @Returns true if the file exists and is readonly </summary>
    ...
    /// file name. If the copy orperation fails, an underscore and a number will be appended
...
type
  ...
  public
    ...
    function GetParts(_sl: TStrings): Integer;
    ///<summary>
...
class function TFileSystem.MakeValidFilename(const _s: string; _ReplaceChar: Char): string;
var
  i: Integer;
begin
  Result := _s;
