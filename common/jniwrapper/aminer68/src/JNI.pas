...
{return value enum}
  ...
  PPJavaVM = ^PJavaVM;
   ...
   JNINativeInterface_ = packed record
      ...
      DefineClass : function(env : PJNIEnv; const name : PAnsiChar; loader : jobject; const buf : PJByte; len : jsize) : jclass ; stdcall;
      ...
      ThrowNew : function(env : PJNIEnv; clazz: jclass; const msg : PAnsiChar) : jint ; stdcall;
      ...
      GetMethodID : function(env: PJNIEnv; clazz : Jclass; const name, sig : PAnsiChar) : jmethodID ; stdcall;
      ...
      GetFieldId : function (env: PJNIEnv; clazz : jclass; const name, sig : PAnsiChar) : jfieldID ; stdcall;
      ...
      GetStaticMethodID : function (env: PJNIEnv; clazz : jclass; const name, sig : PAnsiChar) : jmethodID ; stdcall;
      ...
      GetStaticFieldID : function (env: PJNIEnv ; clazz : jclass ; const name, sig : PAnsiChar) : jfieldID ; stdcall;
      ...
      NewStringUTF : function (env: PJNIEnv ; const utf : PAnsiChar) : jstring ; stdcall;
      GetStringUTFLength : function (env : PJNIEnv ; str : jstring) : jsize ; stdcall;
      GetStringUTFChars : function (env : PJNIEnv ; str : jstring ; var isCopy : jboolean) : PAnsiChar ; stdcall;
      ReleaseStringUTFChars : procedure (env : PJNIEnv ; str : jstring ; const chars : PAnsiChar) ; stdcall;
...
{from here, it's only supported by Java 2}
      ...
      GetStringUTFRegion : procedure(env : PJNIEnv; str : jstring; start, len : jsize; buf : PAnsiChar) ; stdcall;
...
{The following structures will be VM-specific}
    ...
    JDK1_1InitArgs = packed record
       ...
       classpath : PAnsiChar;
       vfprintf : function (filePointer : Pointer ; const format : PAnsiChar ; args : va_list) : jint ; stdcall;
