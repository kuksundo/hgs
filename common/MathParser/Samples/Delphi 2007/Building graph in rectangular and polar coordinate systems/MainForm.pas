...
uses
  ...
  XPStyleActnCtrls, ActnList, ActnMan, ActnCtrls, AppEvnts, StdActns, ImgList,
  StdCtrls, ExtCtrls, ComCtrls, ToolWin, ActnMenus, Menus, Calculator,
  Clipbrd, Graph;
...
uses
  GraphicUtils, Math, NumberUtils, Parser, TextConsts, TextUtils;
