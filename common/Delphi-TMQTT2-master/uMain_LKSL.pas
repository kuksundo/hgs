...
//  MQTT.Password := 'pjh';
  ...
  begin
    mStatus.Lines.Add('Connected to ' + eIP.Text + ' on ' + ePort.Text + ', Client ID: ' + MQTT.ClientID);
    btnSubscribeClick(nil);
  end
  else
...
//      MQTT.Subscribe(eSubTopic.Text+'_', 0);
      mStatus.Lines.Add('Subscribe : ' + eSubTopic.Text);
//      mStatus.Lines.Add('Subscribe : ' + eSubTopic.Text+'_');
    end;
end;
...
begin
  MQTT.DoUnSubscribe(eSubTopic.Text);
end;
